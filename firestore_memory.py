    ...
    def __init__(self, session_id: Optional[str] = None):
        ...
        try:
            ...
            self.firestore_history = FirestoreChatMessageHistory(
                ...
                user_id="classroom_assistant",  # Fixed user ID for the assistant
...
def initialize_firestore_memory(session_id: Optional[str] = None) -> FirestoreMemoryManager:
    """
    ...
    if _firestore_memory_manager is None or session_id is not None:
        _firestore_memory_manager = FirestoreMemoryManager(session_id)
